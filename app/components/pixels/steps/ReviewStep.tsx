...
export function ReviewStep({ selectedPlatforms, platformConfigs, backendUrlInfo }: ReviewStepProps) {
  return (
    <Card>
      <BlockStack gap="400">
          ...
          <Banner tone="critical">
            <BlockStack gap="300">
              ...
              <Text as="p" variant="bodySm">
                <strong>像素扩展配置中仍包含 __BACKEND_URL_PLACEHOLDER__，这表明构建流程未正确替换占位符。</strong>
        ...
        {!backendUrlInfo?.placeholderDetected && backendUrlInfo?.isConfigured && (
          <Banner tone="info">
            <BlockStack gap="200">
              ...
              <Text as="p" variant="bodySm">
                扩展的 BACKEND_URL 已正确注入。生产环境部署时，请确保始终使用 <code>pnpm deploy:ext</code>{" "}
                命令，该命令会自动执行 <code>pnpm ext:inject</code> 注入 BACKEND_URL。禁止直接使用{" "}

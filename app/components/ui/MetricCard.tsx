...
export function MetricCard({
  ...
  const displayTrendPeriod = trendPeriod || t("metricCard.defaultTrendPeriod");
  const getTrendColor = () => {
    switch (trend) {
      case "up":
        return "success";
    ...
    <Card>
      <BlockStack gap="300">
        ...
        {highlightDifference && (
          ...
          >
            {t("metricCard.difference", { value: `${difference >= 0 ? "+" : ""}${difference.toLocaleString()}`, percent: differencePercent })}
          </Text>
        )}
      </BlockStack>
    </Card>

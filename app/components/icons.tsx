...
export const ArrowUpIcon: IconSource = createIcon("M10 3l5 5h-3v7H8V8H5l5-5z");

export const ArrowDownIcon: IconSource = createIcon("M10 17l-5-5h3V5h4v7h3l-5 5z");
...
export const XCircleIcon: IconSource = createIcon(
  "M10 2a8 8 0 100 16 8 8 0 000-16zm3.5 10.1l-1.4 1.4L10 11.4l-2.1 2.1-1.4-1.4L8.6 10 6.5 7.9l1.4-1.4L10 8.6l2.1-2.1 1.4 1.4L11.4 10l2.1 2.1z"
);
...
export const RefreshIcon: IconSource = createIcon("M4 10a6 6 0 019.5-4.77V3h2v5h-5V6h2.5A4 4 0 106 10H4z");
...
export const InfoIcon: IconSource = createIcon("M10 2a8 8 0 100 16 8 8 0 000-16zm1 5h-2V5h2v2zm0 2v6h-2V9h2z");
...
export const PlayIcon: IconSource = createIcon("M6 4l10 6-10 6V4z");

export const PauseIcon: IconSource = createIcon("M6 4h3v12H6V4zm5 0h3v12h-3V4z");

export const StopIcon: IconSource = createIcon("M5 5h10v10H5V5z");

export const FileIcon: IconSource = createIcon("M4 4a2 2 0 012-2h5l5 5v9a2 2 0 01-2 2H6a2 2 0 01-2-2V4zm7-1v5h5l-5-5z");
...
export const ChevronDownIcon: IconSource = createIcon("M5 7l5 5 5-5H5z");

export const ChevronUpIcon: IconSource = createIcon("M5 13l5-5 5 5H5z");
...
export const FilterIcon: IconSource = createIcon("M3 4h14v2H3V4zm2 4h10v2H5V8zm3 4h4v2H8v-2z");

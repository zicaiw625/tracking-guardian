                    ...
                    <>
                      ...
                      <DataTable
                        ...
                        rows={latestRun.results.map((r) => {
                          ...
                          const unavailableEvents = ["refund", "order_cancelled", "order_edited", "subscription_created", "subscription_updated", "subscription_cancelled"];
                          ...
                          if (r.status === "missing_params" && r.discrepancies) {
                            ...
                            if (missingFields.length > 0) {
                              const knownFields = knownLimitations[r.eventType] || [];
                          ...
                          if (unavailableEvents.includes(r.eventType)) {

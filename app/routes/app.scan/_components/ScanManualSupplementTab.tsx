      ...
      <Box paddingBlockStart="400">
        <Card>
          <BlockStack gap="400">
            ...
            <Banner
              tone="critical"
              title={t("scan.manualSupplement.deadline.title", {
                ...
                <InlineStack align="space-between" blockAlign="start">
                  <BlockStack gap="200">
                    <Text as="p" fontWeight="semibold">
                      {t("scan.manualSupplement.howTo.title")}
                    </Text>
                    <Text as="p" variant="bodySm">
                      {t("scan.manualSupplement.howTo.step1")}
                      <br />
                      {t("scan.manualSupplement.howTo.step2")}
                      <br />
                      {t("scan.manualSupplement.howTo.step3")}
                      <br />
                      {t("scan.manualSupplement.howTo.step4")}
                    </Text>
                  </BlockStack>
                  <InlineStack gap="200">
                    <Button onClick={onOpenGuidedSupplement} variant="primary" size="slim">
                      {t("scan.manualSupplement.buttons.upgradeWizard")}
                    </Button>
                    <Button onClick={onOpenManualInputWizard} size="slim">
            ...
            {analysisProgress && (
              <Box paddingBlockStart="200">
                <Text as="p" variant="bodySm" tone="subdued">
                  {t("scan.manualSupplement.progress", {
          ...
          <BlockStack gap="400">
            ...
            <BlockStack gap="200">
              {replacementChecklistItems.map((item, index) => {
                ...
                const replacement = hasTracking
                  ? t("scan.manualSupplement.checklist.suggestions.webPixel")
                  : hasDomRisk
                    ? t("scan.manualSupplement.checklist.suggestions.uiExtension")
                    : t("scan.manualSupplement.checklist.suggestions.manual");
                    ...
                    <Box key={index} background="bg-surface-secondary" padding="400" borderRadius="200">
                      <BlockStack gap="200">
                        <Text as="h3" variant="headingSm">
                          📋 {t("scan.manualSupplement.migrationSuggestions.comprehensive")}
                        </Text>
                        <List type="number">
                          {details.map((d, i) => {
        ...
        <Card>
          <BlockStack gap="400">
            <InlineStack align="space-between" blockAlign="center">
              ...
              {analysisSaved ? <Badge tone="success">{t("scan.manualSupplement.save.saved")}</Badge> : null}
            </InlineStack>
            ...
            <InlineStack gap="200" align="end">
              {scriptContent.trim() && (
                ...
                >
                  {pasteProcessed
                    ? t("scan.manualSupplement.save.processed")
                    : t("scan.manualSupplement.save.processPaste")}
                </Button>
              )}
              <Button

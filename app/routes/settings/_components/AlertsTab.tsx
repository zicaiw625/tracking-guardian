import { Card, Text, BlockStack, InlineStack, Button, Select, TextField, Box, Divider, Banner } from "@shopify/polaris";
                  ...
                  <InlineStack align="space-between" blockAlign="center" gap="400">
                    <InlineStack gap="200">
                      ...
                      <Text as="span" variant="bodySm" tone="subdued">
                        {t("settings.alerts.threshold")} {c.discrepancyThreshold}% ·{" "}
                        {c.isEnabled ? t("common.enabled") : t("common.disabled")}
                      </Text>
                    </InlineStack>
                    <Button variant="plain" tone="critical" onClick={() => handleRemove(c.id)} disabled={isSubmitting}>
                      {t("common.delete")}
                    </Button>
                  </InlineStack>
                  <Divider />

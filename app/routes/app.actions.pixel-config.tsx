...
import { rollbackConfig, switchEnvironment, type PixelEnvironment } from "../services/pixel-rollback.server";
  ...
  try {
    switch (actionType) {
      ...
      case "switch_environment": {
        ...
        if (result.success && result.previousEnvironment !== "live" && result.newEnvironment === "live") {

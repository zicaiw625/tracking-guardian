...
export const GDPRDataRequestPayloadSchema = z
  .object({
    shop_id: z.number(),
...
export const GDPRCustomerRedactPayloadSchema = z
  .object({
    shop_id: z.number(),
    shop_domain: z.string(),
...
export const GDPRShopRedactPayloadSchema = z
  .object({
    shop_id: z.number(),
    shop_domain: z.string(),
  })
...
export type ValidationResult<T> = { success: true; data: T } | { success: false; error: string; issues?: z.ZodIssue[] };

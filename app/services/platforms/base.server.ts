export type PlatformErrorType = "auth_error" | "invalid_config" | "rate_limited" | "server_error" | "timeout" | "network_error" | "validation_error" | "quota_exceeded" | "unknown";
...
export function calculateBackoff(attempt: number, baseDelayMs = 1000, maxDelayMs = 300000): number {

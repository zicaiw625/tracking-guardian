...
// For strict mode, configure TikTok Events API via Tracking Guardian settings instead.
...
register(({ analytics, browser }) => {
  ...
  if (!browser?.window || !browser?.document) {
    console.warn('[Tracking Guardian] TikTok Pixel requires lax sandbox mode. Use server-side tracking for strict mode.');
    return;
  }

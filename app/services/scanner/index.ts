...
export async function getCachedScanResult(
    ...
    return {
        ...
        _additionalScriptsNote: "Additional Scripts must be identified via manual paste; the Shopify API cannot automatically read Additional Scripts content from checkout.liquid",
    };
}

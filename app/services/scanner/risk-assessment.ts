...
export const RISK_RULES: RiskRule[] = [
    {
        ...
        name: "Deprecated ScriptTag",
        description: "Uses the soon-to-be-deprecated ScriptTag API",
        severity: "high",
        points: 30,
    },
    {
        ...
        description: "Traditional tracking detected in ScriptTag, migration to Web Pixel recommended",
        severity: "medium",
        points: 20,
    },
    {
        ...
        description: "Relying solely on client-side tracking may be affected by ad blockers and browser privacy settings",
        severity: "low",
        points: 10,
    },
    {
        id: "outdated_pixel_version",
        name: "Outdated Pixel Version",
        description: "Uses an outdated version of tracking pixel code",
        severity: "medium",
        points: 15,
    },
];

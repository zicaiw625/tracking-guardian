...
export const PLATFORM_INFO: Record<string, PlatformInfo> = {
    ...
    fairing: {
        ...
        officialApp: "https://apps.shopify.com/fairing",
    },
    kno: {
        name: "KnoCommerce (Survey)",
        supportLevel: "unsupported",
        recommendation: "KnoCommerce 有官方 Shopify 应用。如脚本是官方应用生成的，会自动迁移",
        officialApp: "https://apps.shopify.com/kno-commerce",
    },
    zigpoll: {
        name: "Zigpoll (Survey)",
        supportLevel: "unsupported",
    ...
    reconvert: {
        ...
        officialApp: "https://apps.shopify.com/reconvert",
    },
    zipify: {
    ...
    postscript: {
        ...
        officialApp: "https://apps.shopify.com/postscript",
    },
    shopify_analytics: {

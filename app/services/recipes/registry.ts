...
export const GA4_BASIC_RECIPE: MigrationRecipe = {
  ...
  steps: [
    ...
    },
    {
      ...
      actionType: "manual",
      estimatedMinutes: 5,
      helpUrl: "https://support.google.com/analytics/answer/9216061",
    },
    {
      order: 4,
      title: "清理旧 ScriptTag",
...
export const META_CAPI_RECIPE: MigrationRecipe = {
  ...
  steps: [
    ...
    },
    {
      ...
      actionType: "manual",
      estimatedMinutes: 5,
      helpUrl: "https://www.facebook.com/business/help/898185560232180",
    },
    {
      order: 5,
      title: "清理旧 Pixel 代码",
...
export const TIKTOK_EVENTS_RECIPE: MigrationRecipe = {
  ...
  icon: "🎵",
  docsUrl: "https://ads.tiktok.com/marketing_api/docs?id=1739584860883969",
};

...
export async function createSubscription(admin: AdminGraphQL, shopDomain: string, planId: PlanId, returnUrl: string, isTest = false): Promise<SubscriptionResult> {
...
export async function getSubscriptionStatus(admin: AdminGraphQL, shopDomain: string): Promise<SubscriptionStatus> {
    try {
...
export async function cancelSubscription(admin: AdminGraphQL, shopDomain: string, subscriptionId: string): Promise<{
    success: boolean;
    error?: string;
}> {
    try {
...
export async function syncSubscriptionStatus(admin: AdminGraphQL, shopDomain: string): Promise<void> {
...
export async function getOrCreateMonthlyUsage(shopId: string, yearMonth?: string): Promise<{
    id: string;
    sentCount: number;
}> {
...
async function isOrderAlreadyCounted(shopId: string, orderId: string, yearMonth: string): Promise<boolean> {
...
export async function incrementMonthlyUsage(shopId: string, orderId: string): Promise<number> {
...
export async function incrementMonthlyUsageIdempotent(shopId: string, orderId: string): Promise<{
    incremented: boolean;
    current: number;
}> {
    const yearMonth = getCurrentYearMonth();
...
export async function checkOrderLimit(shopId: string, shopPlan: PlanId): Promise<{
    exceeded: boolean;
    current: number;
    limit: number;
    remaining: number;
...
export async function checkBillingGate(shopId: string, shopPlan: PlanId): Promise<{
    allowed: boolean;
...
export async function handleSubscriptionConfirmation(admin: AdminGraphQL, shopDomain: string, chargeId: string): Promise<{
    success: boolean;
    plan?: PlanId;
    error?: string;
}> {

...
export function generateChecklistMarkdown(checklist: TestChecklistInput, locale: string = "en"): string {
  ...
  let markdown = `# 验收测试清单\n\n`;
  markdown += `**生成时间**: ${new Date(checklist.generatedAt ?? 0).toLocaleString(dateLocale)}\n`;

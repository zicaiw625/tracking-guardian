...
export default reactExtension(
  ...
  function OrderStatusExtension() {
    ...
    const invoiceText = typeof settings.invoice_button_text === "string" && settings.invoice_button_text.trim() ? settings.invoice_button_text : "Invoice";
    ...
    const surveyText = typeof settings.survey_button_text === "string" && settings.survey_button_text.trim() ? settings.survey_button_text : "Survey";
    ...
    const aftersalesText = typeof settings.aftersales_button_text === "string" && settings.aftersales_button_text.trim() ? settings.aftersales_button_text : "Aftersales";
      ...
      <BlockStack spacing="loose">
        {showBanner && (
          <Banner title={bannerTitle}>
            <Text>This block is a static message; for real-time tracking status see Verification / Monitoring in the app.</Text>
          </Banner>
        )}
